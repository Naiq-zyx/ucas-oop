...
### 测试用例说明
- [tests/test_demo.py](tests/test_demo.py)：ResNet18 集成烟囱测试。执行前向 + 反向（loss.backward），导出 Mermaid（含 legend），验证端到端采集/渲染链路。

- [tests/test_inspector_unit.py](tests/test_inspector_unit.py)：
